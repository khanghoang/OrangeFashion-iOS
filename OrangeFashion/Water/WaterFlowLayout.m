...
- (CGFloat)initialize
{
    ...
    for (int i = 0; i< _cellCount ; i++)
    {
        ...
        if(self.cellHeight.count < numberOfColumns)
        {
            ...
            PSUICollectionViewLayoutAttributes* attribute = [PSUICollectionViewLayoutAttributes layoutAttributesForCellWithIndexPath:path];
...
{
    return [attributes filteredArrayUsingPredicate:[NSPredicate predicateWithBlock:^BOOL(PSUICollectionViewLayoutAttributes *evaluatedObject, NSDictionary *bindings) {
