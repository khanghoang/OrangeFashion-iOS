...
@protocol UICollecitonViewDelegateWaterFlowLayout <PSUICollectionViewDelegate>

- (CGFloat)flowLayout:(WaterFlowLayout *)flowView heightForRowAtIndex:(int)i;

@end

@protocol UICollectionViewDataSourceWaterFlowLayout <PSUICollectionViewDataSource>

- (NSInteger)numberOfColumnsInFlowLayout:(WaterFlowLayout*)flowlayout;

@end

@interface WaterFlowLayout : PSUICollectionViewLayout
{
