...
@interface PSActionSheet() <UIActionSheetDelegate> {
    id<UIActionSheetDelegate> _realDelegate;
    NSMutableArray *_blocks;
    void (^_destroyBlock)(PSActionSheet *sheet, NSInteger buttonIndex);
}
@end
...
- (void)setDestructiveButtonWithTitle:(NSString *) title extendedBlock:(void (^)(PSActionSheet *sheet, NSInteger buttonIndex))block {
...
- (void)setDestructiveButtonWithTitle:(NSString *)title block:(void (^)())block {
    block = [block copy];
    [self setDestructiveButtonWithTitle:title extendedBlock:^(PSActionSheet *alert, NSInteger buttonIndex) {
        if (block) block();
    }];
}

- (void)setCancelButtonWithTitle:(NSString *) title extendedBlock:(void (^)(PSActionSheet *sheet, NSInteger buttonIndex))block {
...
- (void)setCancelButtonWithTitle:(NSString *)title block:(void (^)())block {
    block = [block copy];
    [self setCancelButtonWithTitle:title extendedBlock:^(PSActionSheet *sheet, NSInteger buttonIndex) {
        if (block) block();
    }];
}

- (void)addButtonWithTitle:(NSString *) title extendedBlock:(void (^)(PSActionSheet *sheet, NSInteger buttonIndex))block {
...
- (void)addButtonWithTitle:(NSString *)title block:(void (^)())block {
    block = [block copy];
    [self addButtonWithTitle:title extendedBlock:^(PSActionSheet *alert, NSInteger buttonIndex) {
        if (block) block();
    }];
}
