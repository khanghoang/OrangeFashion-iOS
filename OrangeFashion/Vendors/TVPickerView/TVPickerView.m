...
-(void) initializePickerSubviews {
    ...
    UIImage *plusNormalStateImage = [[UIImage imageNamed:@"plus"] resizableImageWithStandardInsets];
    UIImage *plusPressedStateImage = [[UIImage imageNamed:@"plus_press"] resizableImageWithStandardInsets];
    
    UIImage *minusNormalStateImage = [[UIImage imageNamed:@"minus"] resizableImageWithStandardInsets];
    UIImage *minusPressedStateImage = [[UIImage imageNamed:@"minus_press"] resizableImageWithStandardInsets];
    ...
    _decrementIndexBtn.frame = CGRectMake(0, 0, self.frame.size.height, self.frame.size.height);
    ...
    _contentView = [[UITextField alloc] initWithFrame:CGRectMake(_decrementIndexBtn.frame.size.width, 0, self.frame.size.width - (_decrementIndexBtn.size.width + _decrementIndexBtn.size.width), _decrementIndexBtn.frame.size.height)];
    ...
    _incrementIndexBtn.frame = CGRectMake(_decrementIndexBtn.frame.size.width + _contentView.frame.size.width, 0, self.frame.size.height, self.frame.size.height);
